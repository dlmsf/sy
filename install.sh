...
NODE_ENTRY_POINTS_CMD="sy syapp sypm sydb pkg pack arc labssh qemujs codeparser jsinfo bundler portclear replacer gitview struct shinstall codereplacer"
